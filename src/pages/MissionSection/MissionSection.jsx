      ...
      <Fade>
        ...
        <CrxGrid p='2.5rem 0' columns='repeat(2, 1fr)' gap='5rem'>
            <CrxGlassCard w='100%' h='225px' p='1.25rem 2.5rem'>
                ...
                CRX aims to revolutionize decentralized finance by providing secure, scalable, and innovative financial solutions that empower users and promote long-term value and financial freedom.
                </CrxTypography>
                </Fade>
                </CrxFlex>
            </CrxGlassCard>
